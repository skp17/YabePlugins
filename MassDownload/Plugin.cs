/*
* @file            MassDownload.cs
* @brief
* @author          Steven Peters
* @date            Generated on 2023-12-13 at 12:00:00
* @note            
*
*/
using System;
...
namespace MassDownload // namespace should have the same name as the dll file
{
    public class Plugin : IYabePlugin // class should be named Plugin and implementation of IYabePlugin is required 
    {
        ...
        public void MenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                Trace.WriteLine("Call to the MassDownload plugin");

                MassDownloadForm frm = new MassDownloadForm(yabeFrm);
                frm.ShowDialog();
            }
            catch (Exception ex)
            {
